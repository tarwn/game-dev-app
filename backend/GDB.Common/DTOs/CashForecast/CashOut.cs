...
namespace GDB.Common.DTOs.CashForecast
{
    public class CashOut : IIdentifiedObject
    {
        ...
        public CashOut(string parentId, string globalId, IdentifiedPrimitive<CashOutType> type, IdentifiedPrimitive<decimal> amount, IdentifiedPrimitive<DateTime>  startDate, IdentifiedPrimitive<decimal> limitFixedAmount = null, IdentifiedPrimitive<int> numberOfMonths = null, string field = null)
        {
            ParentId = parentId;
            GlobalId = globalId;
            Amount = amount;
