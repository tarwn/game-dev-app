...
<Instructions
  ...
  <ul>
    <li><b>Where:</b> does geography make a difference?</li>
    <li><b>What language:</b> does language make a difference?</li>
    ...
    <li>
      <b>Time Available:</b>
      They'll play in small chunks of time, a couple hours, long sessions?
    </li>
    <li>
      <b>Extra benefits:</b>
    ...
    <li>
      ...
      Does their career, income, or education make a difference?
    </li>
    <li>
      <b>Demographics:</b>
      Does their age, gender, or family status make a difference?
    </li>
    <li>
      <b>Other interests:</b>
